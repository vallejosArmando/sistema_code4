...
<div class="card">
    ...
    <div class="card-header">
        <td> <a href="<?php echo base_url() ?>/reclamo/agregar" class="btn btn-primary">Agregar</a> </td>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
            ...
            <tbody>
                <?php foreach ($datos as $data) : ?>
                    ...
                    <tr>
                        ...
                        <td> <a href="<?php echo base_url(); ?>/reclamo/editar/<?php echo $data['id']; ?>" class="btn btn-primary"><i class="nav-icon fas fa-edit"></i></a></td>
                        <td> <a href="#" data-href="<?php echo base_url() . '/reclamo/eliminar/' . $dato['id']; ?>" data-toggle="modal" data-target="#confirm-delete" data-placement="top" title="Eliminar registro" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                icon-cancel
            </tbody>
