...
<?php } ?>
              <form  action="<?php echo base_url() ?>/asignacion/actualizar" id="formulario_asignacion" method="POST" enctype="multipart/form-data" >
              <input type="hidden" name="id" value="<?php echo $datos['id']; ?>"
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="id_conf" id="id_conf"  style="width: 100%;">
                    <option selected="selected"> <?php echo $datos['id_conf'] ?>  </option>
...
<?php endforeach; ?>
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="id_empleado" id="id_empleado" style="width: 100%;">
                  <option selected="selected"><?php echo $datos['id_empleado'] ?></option>
