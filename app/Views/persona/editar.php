...
<div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="<?php echo base_url() ?>/persona/actualizar" id="formulario_personas" method="POST" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary" value="editar">                  <a href="<?php echo base_url()?>/persona" class="btn btn-dark ">Cancelar</a> 
