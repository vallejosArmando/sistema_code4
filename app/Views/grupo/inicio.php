      ...
      <tbody>
        <?php foreach ($grupo as $data) : ?>
          <tr>
            ...
            <td> <a href="#" data-href="<?php echo base_url() . '/grupo/eliminar/' . $data['id']; ?>" data-toggle="modal" data-target="#confirm-delete" data-placement="top" title="Eliminar registro" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></td>
          </tr>
        <?php endforeach; ?>
        icon-cancel
      </tbody>
