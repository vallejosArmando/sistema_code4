          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="date" name="fec_inicio" class="form-control" id="fec_inicio" value="<?php echo $datos['fec_inicio'] ?>">
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="date" name="fec_fin" class="form-control" id="fec_fin" value="<?php echo $datos['fec_fin'] ?>">
              </div>
            </div>
          </div>
        </div>
