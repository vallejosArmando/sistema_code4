      ...
      <form action="<?php echo base_url() ?>/usuario/insertar" id="formulario_sistema" method="POST" enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group">
            ...
            <select class="personass" name="id_persona" id="id_persona" style="width: 100%;">
              <option selected="selected"></option>
              <?php foreach ($personas as $area) : ?>

                <option value="<?php echo $area['id'] ?>"><?php echo $area['nombres']; ?></option>
              <?php endforeach; ?>
